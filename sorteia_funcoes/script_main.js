...
let toCadastro = () => {
    // document.getElementById("atualiza").style.cssText = "display: hidde";
    // document.getElementById("cadastro").style.cssText = "display: active";
    // document.getElementById("tabela").style.cssText = "display: active";
